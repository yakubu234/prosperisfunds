...
<body>
    ...
    <section class="welcome py-5">
        <div class="container py-md-4 mt-md-3">
            <h2 class="heading-agileinfo">Our Products <span>ASSET PROCUREMENT PACKAGE</span></h2>
            <span class="w3-line black"></span>
            <div class="row about-tp mt-md-5 pt-5">
                <div class="col-lg-6 welcome-left">
                    <h3>ASSET PROCUREMENT PACKAGE</h3>
                    <h4>
                        Procure your dream asset with ease. With 20% down payment you can acquire your dream asset ranging from electrical home appliances, cell phones E.t.c spanning with period of 3 to 6 months repayment plan with no interest.
                    </h4>
                </div>
