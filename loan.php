...
<body>
    ...
    <section class="welcome py-5">
        <div class="container py-md-4 mt-md-3">
            <h2 class="heading-agileinfo">Our Products <span>LOAN SCHEME PACKAGE</span></h2>
            <span class="w3-line black"></span>
            <div class="row about-tp mt-md-5 pt-5">
                <div class="col-lg-6 welcome-left">
                    <h3>LOAN SCHEME PACKAGE</h3>
                    <h4>
                        ...
                        2. Nepa bill<br>
                        3. Any valid identity card: voters card, international passport, driving licence.<br>
                        4. 1 Guarantor.<br>
                        Visit any of our offices nearest to you, fill a loan form and tick your choice from our list of loan that suits you.
