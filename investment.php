...
<body>
    ...
    <section class="welcome py-5">
        <div class="container py-md-4 mt-md-3">
            <h2 class="heading-agileinfo">Our Products <span>INVESTMENT PACKAGE</span></h2>
            <span class="w3-line black"></span>
            <div class="row about-tp mt-md-5 pt-5">
                <div class="col-lg-6 welcome-left">
                    <h3>What we offer</h3>
                    <h4>We offer a diversified range of portfolio that enables investors to maximise capital for high yields through our cash crops export platform. We have three (3) different investment plans designed for Return on Investment (ROI) between 30% and 40% plus capital after 8 working days per cycle based on the Investment Networth Plan.
                    </h4>
                </div>
                <div class="col-lg-6 welcome-right">
                    <div class="welcome-right-top">
                        <img src="images/invest.jpeg" width="250" alt="" class="img-fluid">
                    </div>
                </div>
                <!-- <div class="col-lg-6 welcome-left">
                    <h3>OUR MISSION: </h3>
    ...
    <section class="wthree-row w3-about py-5">
		<div class="container py-md-4 mt-md-3">
			<h3 class="heading-agileinfo">Investment Package <span>Our 3 investment package are</span></h3>
			<span class="w3-line black"></span>
			<div class="card-deck mt-md-5 pt-5">
				<div class="card">
					<img src="images/diamond.jpeg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
						<h5 class="card-title">Diamond Networth Investment </h5>
						<p class="card-text mb-3 "><h5>1.1M-Above (NGN) 40% ROI</h5></p>
					</div>

				</div>
				<div class="card">
					<img src="images/gold.png" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
						<h5 class="card-title">Gold Networth Investment</h5>
						<p class="card-text mb-3 "><h5>101,000 - 1M (NGN) 35% ROI</h5></p>
					</div>

				</div>
				<div class="card">
					<img src="images/bronze.jpeg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
						<h5 class="card-title">Bronze Networth Investment </h5>
						<p class="card-text mb-3"><h5>10,000-100,000 (NGN) 30% ROI </h5></p>
					</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 w3layouts_getin_info">
                    <h3>Don’t Miss Your Perfect Investments!</h3>
                </div>
